<x-layout>
    <div class="max-w-xl mx-auto p-8 bg-white border border-gray-300 rounded-2xl mt-6" style="box-shadow:none;">
        ...
        <form class="space-y-5" method="POST" action="/tender" enctype="multipart/form-data">
            ...
            <!-- Instansi -->
            <div>
                <label class="block text-base font-medium text-gray-800 mb-1">Instansi</label>
                <input type="text" name="instansi" placeholder="Masukkan Nama Instansi/Perusahaan" class="block w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#1e335f] focus:border-[#1e335f] text-base" value="{{ old('instansi', session('pending_form.instansi')) }}">
            </div>
            <!-- Nama Proyek -->
            <div>
            ...
            <div>
                ...
                <input type="text" name="budget" placeholder="Masukkan Budget Anda" class="block w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#1e335f] focus:border-[#1e335f] text-base" value="{{ old('budget', session('pending_form.budget')) }}">
            </div>
            <!-- Upload Desain -->
            <div>
        ...
        <div id="preview" class="mt-8 p-6 bg-gray-50 border border-gray-200 rounded-lg hidden">
            ...
            <div class="space-y-2">
                ...
                <div><span class="font-semibold">Budget:</span> <span id="preview-budget"></span></div>
        ...
        function showPreview() {
            ...
            document.getElementById('preview-budget').innerText = document.querySelector('input[name="budget"]').value;
