        ...
        <form action="{{ route('admin.produk.store') }}" method="POST" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" name="nama_produk" class="block w-full px-4 py-2 border border-gray-300 rounded-md @error('nama_produk') border-red-500 @enderror" value="{{ old('nama_produk') }}" placeholder="Contoh: kaos, hoodie, almamater, kemeja, jaket" required>
                    @error('nama_produk')
                ...
                <div>
                    ...
                    <input type="number" name="harga" class="block w-full px-4 py-2 border border-gray-300 rounded-md @error('harga') border-red-500 @enderror" value="{{ old('harga') }}" placeholder="Masukkan harga produk" required>
                    @error('harga')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div>
                ...
                <div class="relative">
                    <div id="dropdown-trigger-bahan" class="w-full border border-gray-300 rounded-lg px-4 py-3 text-sm focus-within:ring-2 focus-within:ring-[#1e335f] focus-within:border-[#1e335f] min-h-[50px] cursor-pointer bg-white">
                        ...
                        <div id="placeholder-bahan" class="text-gray-500">Pilih bahan yang tersedia...</div>
                    </div>
            ...
            <div>
                ...
                <div class="relative">
                    <div id="dropdown-trigger-warna" class="w-full border border-gray-300 rounded-lg px-4 py-3 text-sm focus-within:ring-2 focus-within:ring-[#1e335f] focus-within:border-[#1e335f] min-h-[50px] cursor-pointer bg-white">
                        ...
                        <div id="placeholder-warna" class="text-gray-500">Pilih warna bahan yang tersedia...</div>
                    </div>
            ...
            <div>
                ...
                <textarea name="deskripsi" rows="3" class="block w-full px-4 py-2 border border-gray-300 rounded-md @error('deskripsi') border-red-500 @enderror" placeholder="Tambahkan deskripsi produk...">{{ old('deskripsi') }}</textarea>
                @error('deskripsi')
                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                @enderror
            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    console.log('DOM loaded, setting up dropdowns for produk');
