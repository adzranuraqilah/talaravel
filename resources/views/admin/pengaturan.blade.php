...
<div class="px-6 pt-6 pb-10 max-w-3xl mx-auto">
    ...
    <div class="bg-white border border-gray-200 rounded-xl p-6 mb-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-2">
            <div>
                ...
                <input type="text" value="Estetika.os" class="w-full border border-gray-200 rounded-lg px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#1e335f] focus:border-[#1e335f]" />
            </div>
            <div>
                <label class="block text-gray-700 mb-1">Nama Admin</label>
                <input type="text" value="Admin" class="w-full border border-gray-200 rounded-lg px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#1e335f] focus:border-[#1e335f]" />
            </div>
            <div>
                <label class="block text-gray-700 mb-1">Email</label>
                <input type="email" value="admin@estetika.os" class="w-full border border-gray-200 rounded-lg px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#1e335f] focus:border-[#1e335f]" />
            </div>
            <div>
                <label class="block text-gray-700 mb-1">Nomor Telepon</label>
                <input type="text" value="+62 21 1234 5678" class="w-full border border-gray-200 rounded-lg px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#1e335f] focus:border-[#1e335f]" />
            </div>
        </div>
        <div>
            <label class="block text-gray-700 mb-1">Alamat</label>
            <input type="text" value="Jakarta, Indonesia" class="w-full border border-gray-200 rounded-lg px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#1e335f] focus:border-[#1e335f]" />
        </div>
    </div>
    ...
    <div class="bg-white border border-gray-200 rounded-xl p-6 mb-6">
        ...
        <div class="mb-3">
            ...
            <input type="password" class="w-full border border-gray-200 rounded-lg px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#1e335f] focus:border-[#1e335f]" />
        </div>
        <div class="mb-3">
    ...
    <div class="flex justify-end">
        <button class="bg-blue-900 text-white px-5 py-2 rounded-lg font-semibold hover:bg-blue-800 flex items-center gap-2">
