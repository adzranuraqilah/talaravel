<x-layout-admin>
    <div class="p-6">
        <div class="flex items-center gap-4 mb-6">
            ...
            <h1 class="text-2xl font-bold text-gray-900">Edit Tambahan Lain</h1>
        </div>

        <div class="bg-white rounded-lg shadow p-6 max-w-2xl">
            <form action="{{ route('admin.tambahan-lain.update', $tambahanLain->id) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="nama_tambahan" id="nama_tambahan" 
                               value="{{ old('nama_tambahan', $tambahanLain->nama_tambahan) }}"
                               placeholder="Contoh: Hangtag, Woven, Label Brand"
                    ...
                    <div>
                        ...
                        <input type="number" name="harga" id="harga" 
                               value="{{ old('harga', $tambahanLain->harga) }}"
                               min="0" step="1000"
                    ...
                    <div>
                        ...
                        <textarea name="deskripsi" id="deskripsi" rows="4"
                                  ...
                                  class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('deskripsi') border-red-500 @enderror">{{ old('deskripsi', $tambahanLain->deskripsi) }}</textarea>
                        @error('deskripsi')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
