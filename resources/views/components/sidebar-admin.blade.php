    ...
    <nav class="flex-1 px-2 py-4 overflow-y-auto">
        ...
        <ul class="space-y-1">
            <li>
                <a href="/admin/dashboard"
                   class="flex items-center gap-3 px-3 py-2 rounded-lg
                    ...
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 5v6h6"/></svg>
                    Dashboard
                </a>
            </li>
            <li>
                <a href="/admin/pesanan"
                   class="flex items-center gap-3 px-3 py-2 rounded-lg
                          {{ request()->is('admin/pesanan') ? 'bg-blue-100 text-blue-700 font-medium' : 'text-gray-700 hover:bg-gray-100' }}">
            ...
            <li>
                <a href="/admin/produk"
                   class="flex items-center gap-3 px-3 py-2 rounded-lg
                          {{ request()->is('admin/produk') ? 'bg-blue-100 text-blue-700 font-medium' : 'text-gray-700 hover:bg-gray-100' }}">
                          <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20.8 7.6l-8.8 8.8-4.8-4.8"/></svg>                    Produk
                </a>
            </li>
            <li>
                <a href="/admin/pelanggan"
                   class="flex items-center gap-3 px-3 py-2 rounded-lg
                          {{ request()->is('admin/pelanggan') ? 'bg-blue-100 text-blue-700 font-medium' : 'text-gray-700 hover:bg-gray-100' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 7h18M3 12h18M3 17h18"/></svg>
                    Pelanggan
                </a>
            </li>
            <li>
                <a href="/admin/laporan"
                   class="flex items-center gap-3 px-3 py-2 rounded-lg
                          {{ request()->is('admin/laporan') ? 'bg-blue-100 text-blue-700 font-medium' : 'text-gray-700 hover:bg-gray-100' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 3h18v18H3V3zm3 3v12h12V6H6z"/></svg>
                    Laporan
                </a>
            </li>
            <li>
                <a href="/admin/produksi"
                   class="flex items-center gap-3 px-3 py-2 rounded-lg
                          {{ request()->is('admin/produksi') ? 'bg-blue-100 text-blue-700 font-medium' : 'text-gray-700 hover:bg-gray-100' }}">
        ...
        <ul class="space-y-1">
            <li>
                <a href="/admin/pengaturan"
                   class="flex items-center gap-3 px-3 py-2 rounded-lg
                          {{ request()->is('admin/pengaturan') ? 'bg-blue-100 text-blue-700 font-medium' : 'text-gray-700 hover:bg-gray-100' }}">
